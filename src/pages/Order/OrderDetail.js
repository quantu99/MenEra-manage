...
import { faCheck, faChevronRight, faSpinner, faChevronLeft } from '@fortawesome/free-solid-svg-icons';
...
function OrderDetail() {
    ...
    useEffect(() => {
        getOrderDetail(dispatch, orderId, navigate);
    }, []);
    ...
    const handleRemoveOrder = (id) => {
        pushToHistory(dispatch, id, navigate);
    };
    return (
                ...
                <div className={cx('left-div', 'col', 'l-7')}>
                    ...
                    <div className={cx('info-div')}>
                        ...
                        <div className={cx('footer-div')}>
                            ...
                            {orderProcess === 'order arrived' && (
                                <button onClick={() => handleRemoveOrder(orderDetail?._id)} className={cx('btn')}>
                                    Remove this order
                                </button>
                            )}
                        </div>
